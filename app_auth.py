# app с авторизацией и аутентификацией
# OAuth2 с Паролем (и хешированием), Bearer и JWT-токенами
...
if __name__ == "__main__":
    uvicorn.run("app_auth:api", host="127.0.0.1", port=8000, reload=True)